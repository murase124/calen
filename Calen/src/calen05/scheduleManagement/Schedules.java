...
public class Schedules {
	...
	private void setThreeMonthsSchedule(ArrayList<ArrayList<Schedule>> threeMonthsSchedule) {
		this.threeMonthsSchedule = threeMonthsSchedule;
	}
	private void createThreeMonthsSchedule() {
		threeMonthsSchedule.add(new ArrayList<Schedule>());
		threeMonthsSchedule.add(new ArrayList<Schedule>());
		threeMonthsSchedule.add(new ArrayList<Schedule>());
	}
	//次月スケジュール
	...
	public void allUpdateSchedule(LocalDateTime date) {
		...
		setThreeMonthsSchedule(scheduleList);
		updateSchedule();
	}
